...
specture_atk_v1_build:
	@cp ./tests/cases/specture_atk_v1/* ./work
	@find ./tests/lib/ -maxdepth 1 -type f -exec cp {} ./work/ \; 
	@cp ./tests/lib/clib/* ./work
	@cp ./tests/lib/newlib_wrap/* ./work
	@cd ./work && make -s clean && make -s all CPU_ARCH_FLAG_0=c910  ENDIAN_MODE=little-endian CASENAME=specture_atk_v1 FILE=specture_atk_v1 >& specture_atk_v1.case.log 

specture_atk_v2_build:
	@cp ./tests/cases/specture_atk_v2/* ./work
	@find ./tests/lib/ -maxdepth 1 -type f -exec cp {} ./work/ \; 
	@cp ./tests/lib/clib/* ./work
	@cp ./tests/lib/newlib_wrap/* ./work
	@cd ./work && make -s clean && make -s all CPU_ARCH_FLAG_0=c910  ENDIAN_MODE=little-endian CASENAME=specture_atk_v2 FILE=specture_atk_v2 >& specture_atk_v2.case.log 

specture_atk_v4_build:
	@cp ./tests/cases/specture_atk_v4/* ./work
	@find ./tests/lib/ -maxdepth 1 -type f -exec cp {} ./work/ \; 
	@cp ./tests/lib/clib/* ./work
	@cp ./tests/lib/newlib_wrap/* ./work
	@cd ./work && make -s clean && make -s all CPU_ARCH_FLAG_0=c910  ENDIAN_MODE=little-endian CASENAME=specture_atk_v4 FILE=specture_atk_v4 >& specture_atk_v4.case.log 
specture_atk_v5_build:
	@cp ./tests/cases/specture_atk_v5/* ./work
	@find ./tests/lib/ -maxdepth 1 -type f -exec cp {} ./work/ \; 
	@cp ./tests/lib/clib/* ./work
	@cp ./tests/lib/newlib_wrap/* ./work
	@cd ./work && make -s clean && make -s all CPU_ARCH_FLAG_0=c910  ENDIAN_MODE=little-endian CASENAME=specture_atk_v5 FILE=specture_atk_v5 >& specture_atk_v5.case.log
